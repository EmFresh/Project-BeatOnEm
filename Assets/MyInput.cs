...
public partial class @MyInput: IInputActionCollection2, IDisposable
{
    ...
    ~@MyInput()
    {
        Debug.Assert(!m_KeyboardActions.enabled, "This will cause a leak and performance issues, MyInput.KeyboardActions.Disable() has not been called.");
    }
    ...
    private List<IKeyboardActionsActions> m_KeyboardActionsActionsCallbackInterfaces = new List<IKeyboardActionsActions>();
    ...
    public struct KeyboardActionsActions
    {
        ...
        public void AddCallbacks(IKeyboardActionsActions instance)
        {
            if (instance == null || m_Wrapper.m_KeyboardActionsActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_KeyboardActionsActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IKeyboardActionsActions instance)
        {
            @Note1.started -= instance.OnNote1;
            @Note1.performed -= instance.OnNote1;
            @Note1.canceled -= instance.OnNote1;
        ...
        public void RemoveCallbacks(IKeyboardActionsActions instance)
        {
            if (m_Wrapper.m_KeyboardActionsActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IKeyboardActionsActions instance)
        {
            foreach (var item in m_Wrapper.m_KeyboardActionsActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_KeyboardActionsActionsCallbackInterfaces.Clear();
